...
import com.apcovid19project.Adapter.CoronaAdapter;
import com.apcovid19project.Adapter.FAQAdapter;
import com.apcovid19project.Models.Corona;
import com.apcovid19project.Models.FAQ;
import com.apcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Andhra Pradesh").getJSONObject("districtData");
