package com.apcovid19project.Models;

public class Jsons {

    String videos, home_treatment_images, home_treatment_links, toll_numbers, lab_test,
            tweets, faq, epass, tracker, migrant, corona, cbse, vc, go;

    public Jsons() {
    }

    public Jsons(String videos, String home_treatment_images, String home_treatment_links, String toll_numbers, String lab_test, String tweets, String faq, String epass, String tracker, String migrant, String corona, String cbse, String vc, String go) {
        this.videos = videos;
